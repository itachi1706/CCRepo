...
local function checkSite()
  local response = http.get("https://raw.githubusercontent.com/itachi1706/CCRepo/master/version")
  if response then
    return true
  else
    return false
...
term.setTextColor(1)
  ...
  PrintCentered("CCRepo GitHub CC Programs", 5)
...
function thank()
  ...
  PrintCentered("Run 'forceupdate' after reboot", 11)
  PrintCentered("Your Version: "..vCurrent.."", 13)
...
sleep(1)
downloadFiles("https://raw.githubusercontent.com/itachi1706/CCRepo/master/startup", "startup")
downloadFiles("https://raw.githubusercontent.com/itachi1706/CCRepo/master/version", "version")
downloadFiles("https://raw.githubusercontent.com/itachi1706/CCRepo/master/systemFiles/Install/updater", "systemFiles/Install/updater")
downloadFiles("https://raw.githubusercontent.com/itachi1706/CCRepo/master/api/download", "/api/download")
downloadFiles("https://raw.githubusercontent.com/itachi1706/CCRepo/master/api/systemCheck", "/api/systemCheck")
downloadFiles("https://raw.githubusercontent.com/itachi1706/CCRepo/master/api/update", "/api/update")
downloadFiles("https://raw.githubusercontent.com/itachi1706/CCRepo/master/api/printer", "/api/printer")
...
downloadFiles("https://raw.githubusercontent.com/itachi1706/CCRepo/master/FirstInstall.lua", "/Documentation/FirstInstall.lua")
downloadFiles("https://raw.githubusercontent.com/itachi1706/CCRepo/master/forceupdate", "forceupdate")
